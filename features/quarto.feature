Feature:
  ...
  Scenario: cadastrar um quarto
    ...
    When Eu preencho os dados numero 5 tipo 'Quarto Padrão' disponibilidade 'Disponível' preco_diaria '150.0' descricao 'Esse é o quarto de entrada' e clico em cadastrar
    Then Vejo que o meu cadastro 5 foi realizado

  Scenario: remover um quarto
    Given Estou na pagina de quartos
    And O quarto de numero 6 tipo 'Quarto Padrão' disponibilidade 'Disponível' preco_diaria '150.0' descricao 'Esse é o quarto de entrada' existe
  ...
  Scenario: alterar disponibilidade do quarto
    Given Estou na pagina de quartos
    And O quarto de numero 7 tipo 'Quarto Padrão' disponibilidade 'Disponível' preco_diaria '150.0' descricao 'Esse é o quarto de entrada' existe
  ...
  Scenario: alterar o preco da diaria do quarto
    Given Estou na pagina de quartos
    And O quarto de numero 8 tipo 'Quarto Padrão' disponibilidade 'Disponível' preco_diaria '160.0' descricao 'Esse é o quarto de entrada' existe
